...
class AdminChemistryActivity : ErrorSnackBar() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        editableText = findViewById(R.id.editTextChemistry)
    ...
    private fun addImageAndText() {
        ...
        val imageName = "chemistry_image_${System.currentTimeMillis()}.jpg"
        val text = editableText.text.toString()

        // Get a reference to the Firebase Storage location
        val storageReference =
            FirebaseStorage.getInstance().reference.child("chemistry_images").child(imageName)
    ...
    private fun saveDataToFirestore(imageUrl: String, textData: String) {
        ...
        val firestoreReference = FirebaseFirestore.getInstance().collection("chemistry_collection")
